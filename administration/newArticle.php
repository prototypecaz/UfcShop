...
if (
   ...
   //////////////////////////////////////////////////////////////////////////
    ...
    $connexionBdd->getData("INSERT INTO `produits` (`id`, `titre`, `description`, `image`, `prix`, `quantite`, `id_categorie`, `id_marque`,`vendu`) VALUES (NULL,(:titre),(:description),(:image),(:prix),(:quantite),(:idCategorie),(:idMarque),(:vendu));",
    [':titre' => $titreArticle,':description' => $description,':image' => $UPLOADS_BDD.$image,':prix' => $prix,':quantite' => $quantite,':idCategorie' => $idCategorie,':idMarque' => $idMarque, ':vendu' => $vendu]);
